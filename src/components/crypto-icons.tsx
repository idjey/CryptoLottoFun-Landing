...
export const BinanceIcon = (props: SVGProps<SVGSVGElement>) => (
    <svg
        ...
        {...props}
    >
        <path fillRule="evenodd" clipRule="evenodd" fill="currentColor" d="M1248,0c689.3,0,1248,558.7,1248,1248s-558.7,1248-1248,1248 S0,1937.3,0,1248S558.7,0,1248,0L1248,0z"/>
